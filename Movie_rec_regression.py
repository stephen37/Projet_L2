...
f_movies = open("ml-1m/movies.dat", "r")  #MovieID::Title::Genres
f_ratings = open("ml-1m/ratings.dat", "r")  #UserID::MovieID::Rating::Timestamp
f_users = open("ml-1m/users.dat", "r") #UserID::Gender::Age::Occupation::Zip-code
...
# movies = [movie.split('::') for movie in f_movies]
# ratings = [rating.split('::') for rating in f_ratings]
# users = [user.split('::') for user in f_users]
